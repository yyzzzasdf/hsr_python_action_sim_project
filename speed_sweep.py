...
def run_speed_sweep() -> pd.DataFrame:
                ...
                rows.append(
                    {
                        ...
                        "LTurns": int((action_df["Character"] == "L").sum()),
    ...
    fig_waste = plot_waste_heatmap(result_df, v_sparkle=v_sparkle_list[0], v_archer_list=v_archer_list, v_l_list=v_l_list)
    fig_waste.write_html("speed_sweep_waste_heatmap.html")

    fig_alt = plot_alternation_heatmap(result_df, v_sparkle=v_sparkle_list[0], v_archer_list=v_archer_list, v_l_list=v_l_list)
